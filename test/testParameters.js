...
test(
    ...
    function(assert) {
        deepEqual(
            ...
            {},
            "Passing http://www.skeleton.com#test like parameter, return a empty object"
        );
        deepEqual(
            UrlSkeleton.getParameters("https://www.skeleton.com:8080/test/#test"),
            {},
            "Passing https://www.skeleton.com:8080/test/#test like parameter, return a empty object"
        );
        deepEqual(
            UrlSkeleton.getParameters("//www.skeleton.com:80/ok/?v=1&b=2#test"),
            {"v": "1", "b": "2"},
            "Passing http://www.skeleton.com:80/ok/?v=1&b=2#test like parameter, return the object {\"v\": \"1\", \"b\": \"2\"}"
        );
        deepEqual(
            UrlSkeleton.getParameters("https://safe.url-skeleton.com/?p[teste]=1"),
            {"p": {"teste": "1"}},
            "Passing https://safe.url-skeleton.com/?p[teste]=1 like parameter, return the object {\"p\": {\"teste\": \"1\"}}"
        );
        deepEqual(
            UrlSkeleton.getParameters("https://safe.url-skeleton.com/?p[1]=1&p[2]=2"),
            {"p": {"1": "1", "2": "2"}},
            "Passing https://safe.url-skeleton.com/?p[teste]=1 like parameter, return the object {\"p\": {\"1\": \"1\", \"2\": \"2\"}}"
        );
        deepEqual(
            UrlSkeleton.getParameters("https://safe.url-skeleton.com/?p[]=1&p[]=2"),
            {"p": {"0": "1", "1": "2"}},
            "Passing https://safe.url-skeleton.com/?p[teste]=1 like parameter, return the object {\"p\": {\"0\": \"1\", \"1\": \"2\"}}"
        );
        deepEqual(
            UrlSkeleton.getParameters("https%3A%2F%2Fstatic.url-skeleton.com%2Ftest%2F%3Ftest%5B42%5D%3Dtrue%23test"),
            {"test": {"42": "true"}},
            "Passing https%3A%2F%2Fstatic.url-skeleton.com%2Ftest%2F%3Ftest%5B42%5D%3Dtrue%23test like parameter, return the object {\"test\": {\"42\": \"true\"}}"
        );
    }
);
...
test(
    ...
    function(assert) {
        deepEqual(
            ...
            {"t": "1", "b": "4"},
            "Passing ?t-1&b=4#test like parameter, return the object {\"t\": \"1\", \"b\": \"4\"}"
        );
        deepEqual(
            UrlSkeleton.getParameters("#test"),
            {},
            "Passing #test like parameter, return a empty object"
        );
        deepEqual(
            UrlSkeleton.getParameters("/skeleton/?v=1&b=2#test"),
            {"v": "1", "b": "2"},
            "Passing /skeleton/?v=1&b=2#test like parameter, return the object {\"v\": \"1\", \"b\": \"2\"}"
        );
        deepEqual(
            UrlSkeleton.getParameters("www.url-skeleton.com/ok/"),
            {},
            "Passing www.url-skeleton.com/ok like parameter, return a empty object"
        );
        deepEqual(
            UrlSkeleton.getParameters("/ok/?test=1"),
            {"test": "1"},
            "Passing /ok?test=1 like parameter, return the object {\"test\": \"1\"}"
        );
        deepEqual(
            UrlSkeleton.getParameters("/ok/?"),
            {},
            "Passing /ok? like parameter, return a empty object"
        );
        deepEqual(
            UrlSkeleton.getParameters("/ok/?#test"),
            {},
            "Passing /ok/?#test like parameter, return a empty object"
        );
        deepEqual(
            UrlSkeleton.getParameters("/"),
            {},
            "Passing / like parameter, return a empty object"
        );
    }
);
